...
<head>
  ...
  <title>Planta del Guano — Presentación</title>
  ...
  <style>
    ...
    *{box-sizing:border-box}
    ...
    header{
      background: radial-gradient(circle at 10% 10%, rgba(59,122,87,0.1), transparent 10%),
                  linear-gradient(90deg, rgba(59,122,87,0.06), rgba(38,92,59,0.03));
      padding:48px 24px;
    ...
    .plant-figure{background:linear-gradient(135deg,#fff 0,#fff0 40%); border-radius:18px; padding:18px; display:flex; align-items:center; justify-content:center; box-shadow:0 6px 20px rgba(0,0,0,0.08)}
    .plant-figure img{width:100%; max-width:320px; height:auto; border-radius:12px}
    ...
    .fact{flex:1 1 140px; background:#f8fff8; padding:10px; border-radius:10px; text-align:center}
